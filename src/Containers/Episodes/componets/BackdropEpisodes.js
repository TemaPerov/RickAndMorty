...
const BackdropEpisodes = ({ oneEpisode }) => {
  ...
  const peronageImg = () => {
    const charctersUrl = oneEpisode.characters;
    if (charctersUrl) {
      ...
      <Backdrop className={classes.backdrop} open={open}  >
        <Card className={classes.root} >
          ...
          <Typography
            ...
            color="textSecondary"
          >
            Episode name: {oneEpisode.name}
          </Typography>
          <Typography variant="body2" color="textSecondary" component="p">
            Air date : {oneEpisode.air_date}
          </Typography>
          <Button
            variant="contained"
            color="primary"
...
export default BackdropEpisodes;
